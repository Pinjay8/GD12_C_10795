package com.example.gd12_pdf_c_10795
...
import com.example.gd12_pdf_c_10795.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createdPdf(
        ...
        val file = File(pdfPath, "pdf_10795.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.death_note)
